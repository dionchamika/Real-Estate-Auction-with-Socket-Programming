...
import java.io.InputStreamReader; // Read Input Stream
import java.io.PrintWriter;  
import java.net.Socket;

public class ClientHandler1 extends Thread {    // To implement run
